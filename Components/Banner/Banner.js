            ...
            <div className="bg-gray-100">
                <div className="container mx-auto  py-12 sm:py-24">
                    <div className="flex flex-col">
                        <span className="my-6 text-3xl text-center text-gray-800 font-black leading-7 md:leading-10">
                            <Typewriter
                                options={{
                                    strings: ['Hi Guys 🤘', 'My name is Shakhawat Hossain', 'I am a Front-End Developer'],
                                    autoStart: true,
                                    loop: true,
                                }}
                            />
